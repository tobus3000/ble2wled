...
Ideally, use the ESPresense_ firmware on ESP32 devices for BLE scanning 
and MQTT publishing to a Mosquitto broker (running on HomeAssistant_ 
for example).
